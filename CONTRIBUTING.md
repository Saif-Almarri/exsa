...
- One CSS file per component in `components/`
- BEM naming: `.block__element--modifier`
- Token-driven: `var(--color-link)`, never hardcoded colors
- Zero specificity via `:where()`
- Header comment with component description
