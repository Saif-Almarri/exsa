...
All 53 components share 80 CSS custom properties. Every color, every shadow, every border-radius, every gap, every z-index — it all flows from `:root` tokens.
...
```
@layer exsa.tokens      → 80 custom properties
