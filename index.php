...
<main class="pg" id="main-content">
  ...
  <section class="sec sec--alt" id="why">
    ...
    <p class="sec__sub">Each one exists somewhere. Together, they're unique to EXSA.</p>

    <div class="why-grid">
      <div class="why-item">
        <div class="why-item__icon" style="background:color-mix(in srgb,var(--color-link)10%,transparent);"><span class="ic ic-lock"></span></div>
        <div>
          <h4>Guarded Classless</h4>
          <p>Add <code>body class="exsa"</code> to get automatic styling for <code>&lt;nav&gt;</code>, <code>&lt;table&gt;</code>, <code>&lt;form&gt;</code>, <code>&lt;button&gt;</code>, <code>&lt;blockquote&gt;</code>, <code>&lt;dialog&gt;</code>, and more. Add any class to any of those elements — <code>&lt;table class="data-grid"&gt;</code> — and EXSA steps aside. No overrides needed. No <code>!important</code>. You're in control.</p>
        </div>
      </div>
      <div class="why-item">
        ...
        <div>
          <h4>Zero Specificity Wars</h4>
          <p>Cascade layers decide priority before specificity is even checked, so your unlayered CSS — even a single plain class — always beats every layer EXSA ships. Classless element styles additionally use <code>:where()</code> for a specificity of zero. You'll never need <code>!important</code> to override EXSA.</p>
        </div>
      </div>
      <div class="why-item">
...
<span class="cmt">Swap theme → edit every class.</span></pre>
  ...
  <section class="sec">
    ...
    <p class="sec__sub">Bootstrap launched in 2011. Tailwind in 2017. Neither could have built Guarded Classless&trade; — the CSS features didn't exist yet. EXSA is the first framework designed after all three became baseline.</p>
  ...
  <section class="sec" id="quickstart">
    ...
    <p class="sec__sub">No <code>npm install</code>. No build step. No config file. Just drop these into your <code>&lt;head&gt;</code> and every semantic HTML element is styled.</p>
    <div class="code-blk">
      <div class="code-blk__bar">
        <div class="code-blk__dot"></div><div class="code-blk__dot"></div><div class="code-blk__dot"></div>
